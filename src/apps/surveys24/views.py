...
class Surveys2024Index(LoginRequiredMixin, TemplateView):
    login_url = "/users/login/"
    redirect_field_name = "redirect_to"
    template_name = "surveys24/index.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        ui = {
            "cropmarketing": render_to_string(
                "surveys24/row-ui/crop-marketing.html", context
            ),
            "livestockmarketing": render_to_string(
                "surveys24/row-ui/livestock-marketing.html", context
            ),
            "population": render_to_string("surveys24/row-ui/population.html", context),
            "longtermhire": render_to_string(
                "surveys24/row-ui/long-term-hire.html", context
            ),
            "longtermlack": render_to_string(
                "surveys24/row-ui/long-term-lack.html", context
            ),
            "shorttermhire": render_to_string(
                "surveys24/row-ui/short-term-hire.html", context
            ),
            "shorttermlack": render_to_string(
                "surveys24/row-ui/short-term-lack.html", context
            ),
...
class ContentTypeViewSet(ReadOnlyModelViewSet, StandardViewSet):
    ...
    def get_queryset(self):
        return self.queryset.filter(
            Q(app_label="surveys24", model="longtermhire")
            | Q(app_label="surveys24", model="shorttermhire")
        )
