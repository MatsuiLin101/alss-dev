...
class ModelTestCase(TestCase):
    ...
    def test_build_survey(self):
        self.assertEqual(self.builder.survey.farmer_id, "000000000001")
        ...
        self.assertEqual(self.builder.survey.origin_class, 5)
        # self.assertEqual(self.builder.survey.note, "")
        self.assertEqual(self.builder.survey.period, 326)
        self.assertEqual(self.builder.survey.distance, 35)
    ...
    def test_build_land_area(self):
        ...
        # self.assertEqual(self.builder.land_area[0].type, land_type_a)
        # self.assertEqual(self.builder.land_area[0].status, land_status_a)
        #
        ...
        # self.assertEqual(self.builder.land_area[1].type, land_type_b)
        # self.assertEqual(self.builder.land_area[1].status, land_status_b)
        #
        ...
        # self.assertEqual(self.builder.land_area[2].type, land_type_c)
        # self.assertEqual(self.builder.land_area[2].status, land_status_c)

    def test_build_business(self):
        self.builder.build_business()
        # self.assertEqual(len(self.builder.business), 2)
        # self.assertEqual(self.builder.business[0].farm_related_business.name, "無兼營農業相關事業")
    ...
    def test_build_crop_marketing(self):
        ...
        # self.assertEqual(self.builder.crop_marketing[0].product.code,"A001")
        ...
        # self.assertEqual(self.builder.crop_marketing[0].total_yield, 21000)
        # self.assertEqual(self.builder.crop_marketing[0].unit_price, 23)
        # self.assertEqual(self.builder.crop_marketing[0].has_facility, 0)
        # self.assertEqual(self.builder.crop_marketing[0].loss.code, 1)
        #
        # self.assertEqual(self.builder.crop_marketing[1].product.code,"D011")
        ...
        # self.assertEqual(self.builder.crop_marketing[1].total_yield, 7200)
        # self.assertEqual(self.builder.crop_marketing[1].unit_price, 75)
    ...
    def test_build_livestock_marketing(self):
        ...
        # self.assertEqual(self.builder.livestock_marketing[0].product.code,"F002")
        ...
        # self.assertEqual(self.builder.livestock_marketing[0].total_yield, 15)
        # self.assertEqual(self.builder.livestock_marketing[0].unit_price, 5000)
        ...
        #
        # self.assertEqual(self.builder.livestock_marketing[1].product.code,"F001")
        ...
        # self.assertEqual(self.builder.livestock_marketing[1].total_yield, 1500)
        # self.assertEqual(self.builder.livestock_marketing[1].unit_price, 9750)
    ...
    def test_build_annual_income(self):
        ...
        # self.assertEqual(self.builder.annual_income[0].market_type.name,"農作物及其製品(含生產及加工)")
        # self.assertEqual(self.builder.annual_income[0].income_range.name, "500以上")
        # self.assertEqual(self.builder.annual_income[1].market_type.name, "畜禽產品及其製品(含生產及加工)")
        # self.assertEqual(self.builder.annual_income[1].income_range.name, "500以上")
        ...
        # self.assertEqual(self.builder.annual_income[3].income_range.name, "500以上")
    ...
    def test_build_population_age(self):
        ...
        # self.assertEqual(self.builder.population_age[2].count, 2)
        ...
        # self.assertEqual(self.builder.population_age[3].count, 1)
    ...
    def test_build_short_term_hire(self):
        ...
        # self.assertEqual(self.builder.short_term_hire[0].avg_work_day,1)
    ...
    def test_build_lack(self):
        ...
        # self.assertEqual(len(self.builder.survey.lacks.all()),2)
    ...
    def test_build_subsidy(self):
        ...
        #
        #
        # self.assertEqual(self.builder.subsidy.survey.farmer_id,"100101510450")
        ...
        # self.assertEqual(self.builder.subsidy.hour_delta, 0)
