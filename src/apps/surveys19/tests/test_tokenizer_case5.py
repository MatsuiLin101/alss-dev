...
class ModelTestCase(TestCase):
    ...
    def test_build_crop_marketing(self):
        ...
        self.assertEqual(self.builder.crop_marketing[0].product.code, "438")
        self.assertEqual(self.builder.crop_marketing[0].name, "蕃茄（２期）")
        ...
        self.assertEqual(self.builder.crop_marketing[1].product.code, "438")
        self.assertEqual(self.builder.crop_marketing[1].name, "蕃茄（１期）")
    ...
    def test_build_subsidy(self):
        ...
        self.assertEqual(self.builder.subsidy.survey.farmer_id, "100090300780")
        ...
        self.assertEqual(self.builder.refuse[1].extra, "缺工２．０計畫工資較高")
