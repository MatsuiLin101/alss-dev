...
NUMBER_WORKERS_CHOICES = Q(app_label="surveys23", model="longtermhire") | Q(
...
class Survey(Model):
    ...
    lacks = ManyToManyField(
        "surveys23.Lack", blank=True, related_name="surveys", verbose_name=_("Lack")
    )
    management_types = ManyToManyField(
        "surveys23.ManagementType",
        blank=True,
    ...
    review_logs = GenericRelation(ReviewLog, related_query_name="surveys23")
...
class LongTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys23.NumberWorkers", related_query_name="long_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class ShortTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys23.NumberWorkers", related_query_name="short_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class NumberWorkers(Model):
    ...
    content_type = ForeignKey(
        ...
        on_delete=CASCADE,
        related_name="surveys23_number_workers",
    )
