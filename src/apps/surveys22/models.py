...
class Survey(Model):
    ...
    lacks = ManyToManyField(
        "surveys22.Lack", blank=True, related_name="surveys", verbose_name=_("Lack")
    )
...
class LongTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys22.NumberWorkers", related_query_name="long_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class ShortTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys22.NumberWorkers", related_query_name="short_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class NumberWorkers(Model):
    ...
    content_type = ForeignKey(
        ...
        on_delete=CASCADE,
        related_name="surveys22_number_workers",
    )
