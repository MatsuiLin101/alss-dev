...
from apps.surveys22.models import Lack, Survey, FarmerStat, PRODUCT_TYPE_CHOICES
from .abc import BaseStatisticsQueryHelper


class StatisticsQueryHelper110(BaseStatisticsQueryHelper):
...
class StatisticsExporter110(StatisticsQueryHelper110):
    def __init__(self):
        super().__init__()
