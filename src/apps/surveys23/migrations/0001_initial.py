    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "town",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="Town"
                    ),
                ),
                (
                    "code",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_day",
                    models.IntegerField(blank=True, null=True, verbose_name="Min Day"),
                ),
                (
                    "max_day",
                    models.IntegerField(blank=True, null=True, verbose_name="Max Day"),
                ),
                (
                    "update_time",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "has_extra",
                    models.BooleanField(default=False, verbose_name="Has Extra"),
                ),
                (
                    "has_business",
                    models.BooleanField(default=True, verbose_name="Has Business"),
                ),
                (
                    "update_time",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_hour",
                    models.FloatField(blank=True, null=True, verbose_name="Min Hour"),
                ),
                (
                    "max_hour",
                    models.FloatField(blank=True, null=True, verbose_name="Max Hour"),
                ),
                (
                    "type",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.IntegerField(blank=True, null=True, verbose_name="Code"),
                ),
                (
                    "name",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "origin_class",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Origin Class"
                    ),
                ),
                (
                    "main_income_source",
                    models.BooleanField(
                        default=False, verbose_name="Main Income Source"
                    ),
                ),
                (
                    "non_main_income_source",
                    models.BooleanField(
                        default=False, verbose_name="Non Main Income Source"
                    ),
                ),
                (
                    "known_subsidy",
                    models.BooleanField(default=False, verbose_name="Known Subsidy"),
                ),
                (
                    "non_known_subsidy",
                    models.BooleanField(
                        default=False, verbose_name="Non Known Subsidy"
                    ),
                ),
                ("hire", models.BooleanField(default=False, verbose_name="Hire")),
                (
                    "non_hire",
                    models.BooleanField(default=False, verbose_name="Non Hire"),
                ),
                ("note", models.TextField(blank=True, null=True, verbose_name="Note")),
                (
                    "readonly",
                    models.BooleanField(default=True, verbose_name="Read Only"),
                ),
                (
                    "investigator",
                    models.CharField(
                ...
                (
                    "reviewer",
                    models.CharField(
                        blank=True, max_length=10, null=True, verbose_name="Reviewer"
                    ),
                ),
                (
                    "date",
                ...
                (
                    "distance",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Investigation Distance(km)"
                    ),
                ),
                (
                    "period",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Investigation Period"
                    ),
                ),
                (
                    "update_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "heard_app",
                    models.BooleanField(default=False, verbose_name="Heard App"),
                ),
                (
                    "none_heard_app",
                    models.BooleanField(default=False, verbose_name="None Heard App"),
                ),
                (
                    "update_time",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "count",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Number Of People"
                    ),
                ),
                (
                    "avg_lack_day",
                    models.FloatField(
                        blank=True, null=True, verbose_name="Average Lack Day"
                    ),
                ),
                (
                    "update_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extra",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Extra"
                    ),
                ),
                (
                    "update_time",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="surveys23.AgeScope",
                        verbose_name="Age Scope",
                    ),
                ),
                (
                    "gender",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="surveys23.FarmerWorkDay",
                        verbose_name="Farmer Work Day",
                    ),
                ),
                (
                    "gender",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="surveys23.LifeStyle",
                        verbose_name="Life Style",
                    ),
                ),
                (
                    "relationship",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "raising_number",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Raising Number"
                    ),
                ),
                (
                    "year_sales",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Year Sales"
                    ),
                ),
                (
                    "update_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "has_land",
                    models.BooleanField(default=True, verbose_name="Has Land"),
                ),
                (
                    "update_time",
                    models.DateTimeField(
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="surveys23.LandStatus",
                        verbose_name="Land Statuses",
                    ),
                ),
                (
                    "unit",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Area Value"
                    ),
                ),
                (
                    "update_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "land_number",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Land Number"
                    ),
                ),
                (
                    "land_area",
                    models.FloatField(blank=True, null=True, verbose_name="Land Area"),
                ),
                (
                    "plant_times",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Plant Times"
                    ),
                ),
                (
                    "year_sales",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extra",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Extra"
                    ),
                ),
                (
                    "update_time",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="surveys23.FarmRelatedBusiness",
                        verbose_name="Farm Related Business",
                    ),
                ),
                (
                    "survey",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "match",
                    models.BooleanField(default=False, verbose_name="Address Match"),
                ),
                (
                    "mismatch",
                    models.BooleanField(default=False, verbose_name="Address MisMatch"),
                ),
                (
                    "address",
                    models.CharField(
