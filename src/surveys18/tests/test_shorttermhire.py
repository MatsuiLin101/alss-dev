...
def setUp(self):
    ...
    call_command('loaddata', 'test/work-type.yaml', verbosity=0)
    call_command('loaddata', 'test/month.yaml', verbosity=0)
...
def test_create_population(self):
    ...
    self.assertEquals(shorttermhire_list_before_size, shorttermhire_list_after_size+1)
