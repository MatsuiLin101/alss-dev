# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-06-09 08:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datafile', models.FileField(upload_to='surveys18/builders/', verbose_name='DataFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(blank=True, null=True, verbose_name='Count')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('age_scope', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='surveys18.AgeScope', verbose_name='Age Scope')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('management_types', models.ManyToManyField(related_name='surveys', to='surveys18.ManagementType', verbose_name='Management Types')),
            ],
            options={
                'verbose_name': 'Survey',
        ...
        migrations.AddField(
            model_name='refuse',
            name='subsidy',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='refuses', to='surveys18.Subsidy', verbose_name='Subsidy'),
        ),
        migrations.AddField(
            model_name='product',
            name='type',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='business', to='surveys18.FarmRelatedBusiness', verbose_name='Farm Related Business'),
        ),
        migrations.AddField(
            model_name='business',
            name='survey',
