        ...
        AnnualTotal: {
            ...
            Validate: function(){
                ...
                var msg = '【問項1.4】農作物產銷情形之全年產量與平均單價乘積({0}元)與勾選農作物之全年銷售額區間不符'
                          .format(Helper.NumberWithCommas(countTotal));
                Helper.LogHandler.Log(checkedTotal.length == 1 && con, AnnualIncomeHelper.Alert, msg, this.Guids[0]);
                // show total
                var msg ='目前農作物產銷情形之全年產量與平均單價乘積：{0}元'.format(Helper.NumberWithCommas(countTotal));
                ...
                // show total
                var msg ='目前畜禽產銷情形之全年產量與平均單價乘積：{0}元'.format(Helper.NumberWithCommas(countTotal));
