...
from apps.surveys22.models import Survey, ManagementType, Stratify, FarmerStat


class FarmerStatExporter110:
    def __init__(self):
        invalid_farmers = (
    ...
    def get_stratify_df():
        ...
        for i, obj in enumerate(Stratify.objects.all()):
            df.loc[i] = [
                obj.pk,
                obj.code,
                obj.magnification_factor if obj.sample_count > 0 else "-",
            ]
        return df
