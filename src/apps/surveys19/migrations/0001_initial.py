# Generated by Django 2.2 on 2019-04-13 02:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_hour', models.IntegerField(blank=True, null=True, verbose_name='Min Hour')),
                ('max_hour', models.IntegerField(blank=True, null=True, verbose_name='Max Hour')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('survey', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='subsidy', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='short_term_lacks', to='surveys19.Survey', verbose_name='Survey')),
                ('work_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='short_term_lacks', to='surveys19.WorkType', verbose_name='Work Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='short_term_hires', to='surveys19.Survey', verbose_name='Survey')),
                ('work_types', models.ManyToManyField(blank=True, related_name='short_term_hires', to='surveys19.WorkType', verbose_name='Work Types')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('reason', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='refuse', to='surveys19.RefuseReason', verbose_name='Refuse')),
                ('subsidy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refuses', to='surveys19.Subsidy', verbose_name='Subsidy')),
            ],
            options={
                'verbose_name': 'Refuse',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='population_ages', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relationship', to='surveys19.Relationship', verbose_name='Relationship')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='populations', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phones', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
                'verbose_name': 'Phone',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('month', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surveys19.Month', verbose_name='Month')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='no_salary_hires', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_lack_day', models.FloatField(blank=True, null=True, verbose_name='Average Lack Day')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('months', models.ManyToManyField(blank=True, related_name='long_term_lacks', to='surveys19.Month', verbose_name='Months')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='long_term_lacks', to='surveys19.Survey', verbose_name='Survey')),
                ('work_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='long_term_lacks', to='surveys19.WorkType', verbose_name='Work Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_work_day', models.FloatField(blank=True, null=True, verbose_name='Average Work Day')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('months', models.ManyToManyField(blank=True, related_name='long_term_hires', to='surveys19.Month', verbose_name='Months')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='long_term_hires', to='surveys19.Survey', verbose_name='Survey')),
                ('work_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='long_term_hires', to='surveys19.WorkType', verbose_name='Work Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loss', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='livestock_marketing_loss', to='surveys19.Loss', verbose_name='Loss')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='livestock_marketing_product', to='surveys19.Product', verbose_name='Product')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='livestock_marketings', to='surveys19.Survey', verbose_name='Survey')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='livestock_marketing_unit', to='surveys19.Unit', verbose_name='Unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='land_type', to='surveys19.Unit', verbose_name='Unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='land_areas', to='surveys19.LandStatus', verbose_name='Status')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='land_areas', to='surveys19.Survey', verbose_name='Survey')),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='land_areas', to='surveys19.LandType', verbose_name='Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='farm_location', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('loss', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crop_marketing_loss', to='surveys19.Loss', verbose_name='Loss')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='surveys19.Product', verbose_name='Product Code')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='crop_marketings', to='surveys19.Survey', verbose_name='Survey')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crop_marketing_unit', to='surveys19.Unit', verbose_name='Unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('farm_related_business', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='business', to='surveys19.FarmRelatedBusiness', verbose_name='Farm Related Business')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businesses', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('income_range', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surveys19.IncomeRange', verbose_name='Income Range')),
                ('market_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surveys19.MarketType', verbose_name='Market Type')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='annual_incomes', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated')),
                ('survey', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='address_match', to='surveys19.Survey', verbose_name='Survey')),
            ],
            options={
