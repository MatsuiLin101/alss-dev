...
from apps.surveys22.serializers import (
...
class Surveys2022Index(LoginRequiredMixin, TemplateView):
    ...
    template_name = "surveys22/index.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        ui = {
            "cropmarketing": render_to_string(
                "surveys22/row-ui/crop-marketing.html", context
            ),
            "livestockmarketing": render_to_string(
                "surveys22/row-ui/livestock-marketing.html", context
            ),
            "population": render_to_string("surveys22/row-ui/population.html", context),
            "longtermhire": render_to_string(
                "surveys22/row-ui/long-term-hire.html", context
            ),
            "longtermlack": render_to_string(
                "surveys22/row-ui/long-term-lack.html", context
            ),
            "shorttermhire": render_to_string(
                "surveys22/row-ui/short-term-hire.html", context
            ),
            "shorttermlack": render_to_string(
                "surveys22/row-ui/short-term-lack.html", context
            ),
            "nosalaryhire": render_to_string(
                "surveys22/row-ui/no-salary-hire.html", context
            ),
        }
...
class ContentTypeViewSet(ReadOnlyModelViewSet, StandardViewSet):
    ...
    def get_queryset(self):
        return self.queryset.filter(
            Q(app_label="surveys22", model="longtermhire")
            | Q(app_label="surveys22", model="shorttermhire")
        )
