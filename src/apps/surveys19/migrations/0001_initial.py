# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2019-03-18 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='number_workers_19', to='contenttypes.ContentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lacks', models.ManyToManyField(blank=True, related_name='surveys19', to='surveys19.Lack', verbose_name='Lack')),
            ...
            options={
                'verbose_name': 'Survey19',
                'verbose_name_plural': 'Survey19',
            },
        ),
        migrations.CreateModel(
            name='Unit',
        ...
        migrations.AddField(
            model_name='subsidy',
            name='survey',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='subsidy', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='shorttermlack',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='short_term_lacks', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='shorttermlack',
            name='work_type',
        ...
        migrations.AddField(
            ...
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='short_term_hires', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='shorttermhire',
            name='work_types',
        ...
        migrations.AddField(
            model_name='product',
            name='code',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surveys19.ProductCode', verbose_name='Product Code'),
        ),
        migrations.AddField(
            model_name='product',
            name='type',
        ...
        migrations.AddField(
            ...
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='population_ages', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='population',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='populations', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='phone',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phones', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='nosalaryhire',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='no_salary_hires', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='loss',
            name='type',
        ...
        migrations.AddField(
            model_name='longtermlack',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='long_term_lacks', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='longtermlack',
            name='work_type',
        ...
        migrations.AddField(
            model_name='longtermhire',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='long_term_hires', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='longtermhire',
            name='work_type',
        ...
        migrations.AddField(
            model_name='livestockmarketing',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='livestock_marketings', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='livestockmarketing',
            name='unit',
        ...
        migrations.AddField(
            model_name='landarea',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='land_areas', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='landarea',
            name='type',
        ...
        migrations.AddField(
            ...
            name='survey',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='farm_location', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='cropmarketing',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='crop_marketings', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='cropmarketing',
            name='unit',
        ...
        migrations.AddField(
            model_name='business',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businesses', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='annualincome',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='annual_incomes', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
        migrations.AddField(
            model_name='addressmatch',
            name='survey',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='address_match', to='surveys19.Survey19', verbose_name='Survey19'),
        ),
    ]
