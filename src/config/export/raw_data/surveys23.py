...
class RawDataExporter111:
    def __init__(self):
        template = os.path.join(
            settings.BASE_DIR, "config/export/templates/raw_data_111.xlsx"
        )
    ...
    def process_sheet1(self):
        ...
        for refuse in non_heard_refuses:
            ...
            elif refuse.method_pk == 3:
                df2.loc[refuse.farmer_id, "field_ab"] = 1
        ...
        for apply in applies:
            ...
            elif apply.method_pk == 3:
                df2.loc[apply.farmer_id, "field_ac"] = 1
                df2.loc[apply.farmer_id, "field_ad"] = apply.result_pk
    ...
    def __call__(self, *args, **kwargs):
        ...
        for method, sheet_name in zip(
            methods, ["附帶調查_無申請人力團原因", "附帶調查_無申請農業外籍移工原因", "附帶調查_無申請外國籍青農原因"]
        ):
