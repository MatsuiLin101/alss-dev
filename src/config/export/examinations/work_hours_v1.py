...
class WorkHourExaminationExporterV1:
    ...
    def check_exhausted(*gens):
        return all([len(list(gen)) == 0 for gen in gens])
        ...
        while True:
            try:
                ...
                yield [
                    ...
                    min_hours,
                    max_hours,
                    self.get_examination_result_display(
                        hire_hours, min_hours, max_hours
                    ),
