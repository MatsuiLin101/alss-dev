...
class ModelTestCase(TestCase):
    def setUp(self):
        ...
        lst = ["1344,106,640240014040,1,39,,7,蘇受貞　　,0912798577 ,07-6978832 ,否,高雄市路竹區社東里東安路36巷43號,,0,0,0,0,0,0,,,,,,,,,,,,,1,G008,中雞(請填品項，如白肉雞/有色肉雞/蛋雞),4,48200,96500,100,0,,0,1,0,0,0,0,0,1,0,0,自行載送販賣,1,1,2,04900 ,6,7,12. 雞"
        ...
        for string in lst:
            self.builder = SpecialtyBuilder(string)
            self.builder.build()

        string = "6402400140400202+++G01020033600000000066000G01020057500000000054000++++++++"

        self.builder = LaborBuilder(string=string)
        self.builder.build()
