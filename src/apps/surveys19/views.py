...
class Surveys2019Index(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # ui elements
        ui = {
            'cropmarketing': render_to_string('surveys19/row-ui/crop-marketing.html', context),
            'livestockmarketing': render_to_string('surveys19/row-ui/livestock-marketing.html', context),
            'population': render_to_string('surveys19/row-ui/population.html', context),
            'longtermhire': render_to_string('surveys19/row-ui/long-term-hire.html', context),
            'longtermlack': render_to_string('surveys19/row-ui/long-term-lack.html', context),
            'shorttermhire': render_to_string('surveys19/row-ui/short-term-hire.html', context),
            'shorttermlack': render_to_string('surveys19/row-ui/short-term-lack.html', context),
            'nosalaryhire': render_to_string('surveys19/row-ui/no-salary-hire.html', context),
        }
