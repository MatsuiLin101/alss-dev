...
class ModelTestCase(TestCase):
    ...
    def test_build_survey(self):
        ...
        self.assertEquals(self.builder.survey.interviewee_relationship, "本人")
    ...
    def test_build_annual_income(self):
        ...
        self.assertEquals(self.builder.annual_income[2].income_range.name, "70~未滿100")
    ...
    def test_build_population(self):
        ...
        self.assertEquals(self.builder.population[0].relationship.name, "經濟戶長")
        ...
        self.assertEquals(self.builder.population[1].relationship.name, "經濟戶長之配偶")
    ...
    def test_build_subsidy(self):
        ...
        self.assertEquals(self.builder.subsidy.has_subsidy, False)
        self.assertEquals(self.builder.subsidy.none_subsidy, True)
        self.assertEquals(len(self.builder.refuse), 1)
        self.assertEquals(self.builder.refuse[0].reason.name, "其他")
        self.assertEquals(self.builder.refuse[0].extra, "介面字太小")
